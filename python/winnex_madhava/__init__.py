...
def build_engine(
    ...
    *,
    ...
    # OpenMP thread cap (>0 bounds the parallel regions; 0 = OpenMP default).
    # Implemented 2026-09-06 (was a declared-but-unread knob).
    n_threads: int = 0,
    seed: int = 42,
    ...
    if not speed and not is_float_corpus:
    ...
    # OpenMP thread cap (implemented 2026-09-06 — bounds the parallel regions).
    cfg.n_threads = int(n_threads)
...
class _SimpleResult:
    """Minimal SearchResult-like object (used by the speed-mode wrapper)."""
