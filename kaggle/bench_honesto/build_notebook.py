#!/usr/bin/env python3
"""
build_notebook.py — Gera o notebook Kaggle do benchmark HONESTO do winnex-madhava.
...
OUT = os.path.join(os.path.dirname(__file__), "winnex_madhava_honest_benchmark.ipynb")
...
md(["""# winnex-madhava 1.7.1 — Benchmark HONESTO vs GT oficial BIGANN-100M
...
- **Recall normalizado por cobertura**: em subset <100M, o recall bruto é limitado
  pela fração de vizinhos verdadeiros presentes (1M: ~1%, 10M: ~8%). A definição
  normalizada faz um scan exato atingir 1.0.
